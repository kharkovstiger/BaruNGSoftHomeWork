...
public class OrderController {
    ...
    @PostMapping(value = "/getNumberOfOrders")
    public Map<String, Integer> getNumberOfOrders(@RequestBody List<String> list){
        Map<String, Integer> result=new HashMap<>();
        list.forEach(id->result.put(id,orderService.getByCustomerId(id).size()));
        return result;
    }
